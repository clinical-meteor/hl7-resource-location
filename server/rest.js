...
JsonRoutes.add("get", "/fhir/Location", function (req, res, next) {
  ...
  // console.log('GET /fhir/Location', req.query);
  ...
  if (accessToken || process.env.NOAUTH) {
    ...
    process.env.DEBUG && console.log('Locations.find(id)', Locations.find(databaseQuery).fetch());
