...
Locations.toMongo = function (originalLocation) {
  ...
  // if (originalLocation.identifier) {
  //   originalLocation.identifier.forEach(function(identifier){
...
Locations.prepForUpdate = function (location) {
  ...
  //
  //   location.name.forEach(function(name){
...
Locations.prepForFhirTransfer = function (location) {
  ...
  // }
  //
  // //console.log("Locations.prepForBundle()", location);
